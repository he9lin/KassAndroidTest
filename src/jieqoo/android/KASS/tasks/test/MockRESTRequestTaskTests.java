...
public class MockRESTRequestTaskTests extends InstrumentationTestCase {
	...
	public final void testFailureFetch() throws Throwable {
	    ...
	    runTestOnUiThread(new Runnable() {
	        @Override
	        public void run() {
	        	new MockRESTRequestTask(401, Fixtures.LISTING, new RESTListener() {
	...
	public final void testSuccessfulFetch() throws Throwable {
	    ...
	    runTestOnUiThread(new Runnable() {
	        @Override
	        public void run() {
	        	new MockRESTRequestTask(200, Fixtures.LISTING, new RESTListener() {
	    			public void onSuccess(Object response) { 
